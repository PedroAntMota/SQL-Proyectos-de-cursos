...
values
('pedrosword','14pedro13maria'),
('Leecham','sniperpromega')
create table Amigos(
...
select Amigos.nombre,Amigos.apellido,Amigos.Email,Amigos.telefono,Categoria.id_categoria,Genero.id_genero,nombre_categoria as 'Tipo de amigo',Genero.nombre_genero as 'Genero'  from Amigos
